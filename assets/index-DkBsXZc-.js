(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const u of s.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&a(u)}).observe(document,{childList:!0,subtree:!0});function r(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(i){if(i.ep)return;i.ep=!0;const s=r(i);fetch(i.href,s)}})();function we(){return`
        ...
        `}function _e(e,t){return`
            <div class="flex gap-2 bg-gray-800/40 py-4 px-4 rounded-lg">
                <div>
                    <img src="./src/assets/icons/person.svg" alt="Profile Picture" class="w-10 h-10 rounded-full object-cover" />
                </div>
        ...
        `}var Se=/([:*])(\w+)/g,Pe="([^/]+)",ke=/\*/g,Ce="?(?:.*)",He=/\/\?/g,Te="/?([^/]+|)",Ie="(?:/^|^)",je="";function Q(e){return e===void 0&&(e="/"),I()?location.pathname+location.search+location.hash:e}function d(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function O(e){return typeof e=="string"}function Be(e){return typeof e=="function"}function A(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Fe(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(r,a,i){return r===null&&(r={}),r[t[i]]=decodeURIComponent(a),r},null)}function R(e){var t=d(e).split(/\?(.*)?$/);return[d(t[0]),t.slice(1).join("")]}function T(e){for(var t={},r=e.split("&"),a=0;a<r.length;a++){var i=r[a].split("=");if(i[0]!==""){var s=decodeURIComponent(i[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(i[1]||""))):t[s]=decodeURIComponent(i[1]||"")}}return t}function J(e,t){var r=R(d(e.currentLocationPath)),a=r[0],i=r[1],s=i===""?null:T(i),u=[],h;if(O(t.path)){if(h=Ie+d(t.path).replace(Se,function(w,y,_){return u.push(_),Pe}).replace(ke,Ce).replace(He,Te)+"$",d(t.path)===""&&d(a)==="")return{url:a,queryString:i,hashString:A(e.to),route:t,data:null,params:s}}else h=t.path;var m=new RegExp(h,je),p=a.match(m);if(p){var x=O(t.path)?Fe(p,u):p.groups?p.groups:p.slice(1);return{url:d(a.replace(new RegExp("^"+e.instance.root),"")),queryString:i,hashString:A(e.to),route:t,data:x,params:s}}return!1}function Y(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function b(e,t){return typeof e[t]>"u"||e[t]===!0}function Me(e){if(!e)return{};var t=e.split(","),r={},a;return t.forEach(function(i){var s=i.split(":").map(function(u){return u.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":r.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":a||(a={}),a.strategy=s[1];break;case"resolveOptionsHash":a||(a={}),a.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":r[s[0]]=s[1]==="true";break}}),a&&(r.resolveOptions=a),r}function I(){return typeof window<"u"}function Ne(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(r){return r}).forEach(function(r){["before","after","already","leave"].forEach(function(a){r[a]&&(t[a]||(t[a]=[]),t[a].push(r[a]))})}),t}function v(e,t,r){var a=t||{},i=0;(function s(){if(!e[i]){r&&r(a);return}Array.isArray(e[i])?(e.splice.apply(e,[i,1].concat(e[i][0](a)?e[i][1]:e[i][2])),s()):e[i](a,function(u){typeof u>"u"||u===!0?(i+=1,s()):r&&r(a)})})()}v.if=function(e,t,r){return Array.isArray(t)||(t=[t]),Array.isArray(r)||(r=[r]),[e,t,r]};function U(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Q(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function S(e,t){for(var r=0;r<e.instance.routes.length;r++){var a=e.instance.routes[r],i=J(e,a);if(i&&(e.matches||(e.matches=[]),e.matches.push(i),e.resolveOptions.strategy==="ONE")){t();return}}t()}function $e(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Ue(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var z=I(),ze=Y();function De(e,t){if(b(e.navigateOptions,"updateBrowserURL")){var r=("/"+e.to).replace(/\/\//g,"/"),a=z&&e.resolveOptions&&e.resolveOptions.hash===!0;ze?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",a?"#"+r:r),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!a){var i=location.hash;location.hash="",location.hash=i}e.instance.__freezeListening=!1},1))):z&&(window.location.href=e.to)}t()}function Z(e,t){var r=e.instance;if(!r.lastResolved()){t();return}v(r.lastResolved().map(function(a){return function(i,s){if(!a.route.hooks||!a.route.hooks.leave){s();return}var u=!1,h=e.instance.matchLocation(a.route.path,e.currentLocationPath,!1);if(a.route.path!=="*")u=!h;else{var m=e.matches?e.matches.find(function(p){return a.route.path===p.route.path}):!1;u=!m}if(b(e.navigateOptions,"callHooks")&&u){v(a.route.hooks.leave.map(function(p){return function(x,w){return p(function(y){y===!1?e.instance.__markAsClean(e):w()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Ge(e,t){e.match.route.hooks&&e.match.route.hooks.before&&b(e.navigateOptions,"callHooks")?v(e.match.route.hooks.before.map(function(r){return function(i,s){return r(function(u){u===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function qe(e,t){b(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function We(e,t){e.match.route.hooks&&e.match.route.hooks.after&&b(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(r){return r(e.match)}),t()}function Ve(e,t){var r=e.instance.lastResolved();if(r&&r[0]&&r[0].route===e.match.route&&r[0].url===e.match.url&&r[0].queryString===e.match.queryString){r.forEach(function(a){a.route.hooks&&a.route.hooks.already&&b(e.navigateOptions,"callHooks")&&a.route.hooks.already.forEach(function(i){return i(e.match)})}),t(!1);return}t()}function Xe(e,t){var r=e.instance._notFoundRoute;if(r){e.notFoundHandled=!0;var a=R(e.currentLocationPath),i=a[0],s=a[1],u=A(e.to);r.path=d(i);var h={url:r.path,queryString:s,hashString:u,data:null,route:r,params:s!==""?T(s):null};e.matches=[h],e.match=h}t()}function Ke(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Qe(e,t){e.instance._setCurrent(null),t()}function ee(e,t){b(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var te=[Ve,Ge,qe,We],D=[Z,Xe,v.if(function(e){var t=e.notFoundHandled;return t},te.concat([ee]),[Ke,Qe])];function C(){return C=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},C.apply(this,arguments)}function G(e,t){var r=0;function a(){if(r===e.matches.length){ee(e,t);return}v(te,C({},e,{match:e.matches[r]}),function(){r+=1,a()})}Z(e,a)}function P(e){e.instance.__markAsClean(e)}function H(){return H=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},H.apply(this,arguments)}var q="[data-navigo]";function Je(e,t){var r=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:q},a=this,i="/",s=null,u=[],h=!1,m,p=Y(),x=I();e?i=d(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function w(n){return n.indexOf("#")>=0&&(r.hash===!0?n=n.split("#")[1]||"/":n=n.split("#")[0]),n}function y(n){return d(i+"/"+d(n))}function _(n,o,c,f){return n=O(n)?y(n):n,{name:f||d(String(n)),path:n,handler:o,hooks:Ne(c)}}function re(n,o,c){var f=this;return typeof n=="object"&&!(n instanceof RegExp)?(Object.keys(n).forEach(function(l){if(typeof n[l]=="function")f.on(l,n[l]);else{var g=n[l],L=g.uses,ye=g.as,be=g.hooks;u.push(_(l,L,[m,be],ye))}}),this):(typeof n=="function"&&(c=o,o=n,n=i),u.push(_(n,o,[m,c])),this)}function j(n,o){if(a.__dirty){a.__waiting.push(function(){return a.resolve(n,o)});return}else a.__dirty=!0;n=n?d(i)+"/"+d(n):void 0;var c={instance:a,to:n,currentLocationPath:n,navigateOptions:{},resolveOptions:H({},r,o)};return v([U,S,v.if(function(f){var l=f.matches;return l&&l.length>0},G,D)],c,P),c.matches?c.matches:!1}function B(n,o){if(a.__dirty){a.__waiting.push(function(){return a.navigate(n,o)});return}else a.__dirty=!0;n=d(i)+"/"+d(n);var c={instance:a,to:n,navigateOptions:o||{},resolveOptions:o&&o.resolveOptions?o.resolveOptions:r,currentLocationPath:w(n)};v([$e,Ue,S,v.if(function(f){var l=f.matches;return l&&l.length>0},G,D),De,P],c,P)}function ae(n,o,c){var f=M(n,o);return f!==null?(B(f.replace(new RegExp("^/?"+i),""),c),!0):!1}function ie(n){return this.routes=u=u.filter(function(o){return O(n)?d(o.path)!==d(n):Be(n)?n!==o.handler:String(o.path)!==String(n)}),this}function oe(){p&&(this.__popstateListener=function(){a.__freezeListening||j()},window.addEventListener("popstate",this.__popstateListener))}function se(){this.routes=u=[],p&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=h=!0}function ce(n,o){return a._notFoundRoute=_("*",n,[m,o],"__NOT_FOUND__"),this}function F(){if(x)return le().forEach(function(n){if(n.getAttribute("data-navigo")==="false"||n.getAttribute("target")==="_blank"){n.hasListenerAttached&&n.removeEventListener("click",n.navigoHandler);return}n.hasListenerAttached||(n.hasListenerAttached=!0,n.navigoHandler=function(o){if((o.ctrlKey||o.metaKey)&&o.target.tagName.toLowerCase()==="a")return!1;var c=n.getAttribute("href");if(typeof c>"u"||c===null)return!1;if(c.match(/^(http|https)/)&&typeof URL<"u")try{var f=new URL(c);c=f.pathname+f.search}catch{}var l=Me(n.getAttribute("data-navigo-options"));h||(o.preventDefault(),o.stopPropagation(),a.navigate(d(c),l))},n.addEventListener("click",n.navigoHandler))}),a}function le(){return x?[].slice.call(document.querySelectorAll(r.linksSelector||q)):[]}function ue(n){return"/"+i+"/"+d(n)}function fe(n){return m=n,this}function de(){return s}function M(n,o,c){var f=u.find(function(L){return L.name===n}),l=null;if(f){if(l=f.path,o)for(var g in o)l=l.replace(":"+g,o[g]);l=l.match(/^\//)?l:"/"+l}return l&&c&&!c.includeRoot&&(l=l.replace(new RegExp("^/"+i),"")),l}function he(n){return n.getAttribute("href")}function N(n){var o=R(d(n)),c=o[0],f=o[1],l=f===""?null:T(f),g=A(n),L=_(c,function(){},[m],c);return{url:c,queryString:f,hashString:g,route:L,data:null,params:l}}function pe(){return N(d(Q(i)).replace(new RegExp("^"+i),""))}function ge(n){var o={instance:a,currentLocationPath:n,to:n,resolveOptions:r};return S(o,function(){}),o.matches?o.matches:!1}function ve(n,o,c){typeof o<"u"&&(typeof c>"u"||c)&&(o=y(o));var f={instance:a,to:o,currentLocationPath:o};U(f,function(){}),typeof n=="string"&&(n=typeof c>"u"||c?y(n):n);var l=J(f,{name:String(n),path:n,handler:function(){},hooks:{}});return l||!1}function E(n,o,c){return typeof o=="string"&&(o=$(o)),o?(o.hooks[n]||(o.hooks[n]=[]),o.hooks[n].push(c),function(){o.hooks[n]=o.hooks[n].filter(function(f){return f!==c})}):(console.warn("Route doesn't exists: "+o),function(){})}function $(n){return typeof n=="string"?u.find(function(o){return o.name===y(n)}):u.find(function(o){return o.handler===n})}function me(n){n.instance.__dirty=!1,n.instance.__waiting.length>0&&n.instance.__waiting.shift()()}this.root=i,this.routes=u,this.destroyed=h,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=me,this.on=re,this.off=ie,this.resolve=j,this.navigate=B,this.navigateByName=ae,this.destroy=se,this.notFound=ce,this.updatePageLinks=F,this.link=ue,this.hooks=fe,this.extractGETParameters=function(n){return R(w(n))},this.lastResolved=de,this.generate=M,this.getLinkPath=he,this.match=ge,this.matchLocation=ve,this.getCurrentLocation=pe,this.addBeforeHook=E.bind(this,"before"),this.addAfterHook=E.bind(this,"after"),this.addAlreadyHook=E.bind(this,"already"),this.addLeaveHook=E.bind(this,"leave"),this.getRoute=$,this._pathToMatchObject=N,this._clean=d,this._checkForAHash=w,this._setCurrent=function(n){return s=a.current=n},oe.call(this),F.call(this)}async function Ye(){try{const e=await fetch("/src/data/travel_recommendation_api.json");if(!e.ok)throw new Error("Network response was not ok.");return await e.json()}catch(e){return console.error("Error fetching destinations:",e),[]}}function W(e,t,r){return`
        <div class="w-80 bg-gray-700/60 rounded-lg p-4 flex flex-col items-center">
            <div class="w-full h-48 bg-cover bg-center rounded-lg mb-4">
                <img src="${t}" alt="${e}" class="w-full h-full object-cover rounded-lg">
            </div>
            <div>
