        ...
        `
            <section class="flex h-full justify-between px-10">
                <div id="home-text" class="flex flex-col gap-4 w-150 justify-center -mt-25">
                    <h1 class="text-7xl font-bold">EXPLORE DREAM DESTINATION</h1>
                    <p class="text-lg">
                    ...
                    <button type="button" id="exploreButton" class="px-2 py-1 bg-gray-200/10 rounded-lg hover:bg-gray-200/20 cursor-pointer w-40">
                        BOOK NOW
                    </button>
                </div>
